...
FUNCTION Databases( lTake )
   ...
   REDEFINE BTNBMP ID 301 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 1,1], aDBGet1[ 1], aDBGet2[ 1] )
   REDEFINE BTNBMP ID 302 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 2,1], aDBGet1[ 2], aDBGet2[ 2] )
   REDEFINE BTNBMP ID 303 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 3,1], aDBGet1[ 3], aDBGet2[ 3] )
   REDEFINE BTNBMP ID 304 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 4,1], aDBGet1[ 4], aDBGet2[ 4] )
   REDEFINE BTNBMP ID 305 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 5,1], aDBGet1[ 5], aDBGet2[ 5] )
   REDEFINE BTNBMP ID 306 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 6,1], aDBGet1[ 6], aDBGet2[ 6] )
   REDEFINE BTNBMP ID 307 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 7,1], aDBGet1[ 7], aDBGet2[ 7] )
   REDEFINE BTNBMP ID 308 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 8,1], aDBGet1[ 8], aDBGet2[ 8] )
   REDEFINE BTNBMP ID 309 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[ 9,1], aDBGet1[ 9], aDBGet2[ 9] )
   REDEFINE BTNBMP ID 310 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[10,1], aDBGet1[10], aDBGet2[10] )
   REDEFINE BTNBMP ID 311 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[11,1], aDBGet1[11], aDBGet2[11] )
   REDEFINE BTNBMP ID 312 OF oDlg RESOURCE "B_OPEN" TRANSPARENT NOBORDER TOOLTIP GL("Open") ACTION GetDBase( oGenVar:aDBFile[12,1], aDBGet1[12], aDBGet2[12] )
