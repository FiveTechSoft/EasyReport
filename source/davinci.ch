...
#define IPF_MSGBOX                   0x1 //L // 
#define IPF_DIB                      0x8 //L // 
#define IPF_META                    0x10 //L // 
#define IPF_ENH                    0x800 //L // 
#define IPF_COMPRESS                 0x2 //L // 

#define IPF_TIFF_APPEND         0x200000 //L // TIFF-Write: Append Page to existing TIF file.
...
#define IPF_QUALITY               0xF000 //L // JPEG- 0x1000: 0x9000 
#define IPF_LOWQUALITY            0x3000 //L // JPEG
#define IPF_INTERLACED           0x10000 //L // PNG/GIF-Write: Write in interlaced Mode
#define IPF_PNG_INTERLACED       IPF_INTERLACED // Obsolete

#define IPF_FILEDIALOG               0x4 //L // 

#define IPF_NOPROGRESSBAR          0x100 //L // 
#define IPF_NOWAIT                 IPF_NOPROGRESSBAR // 
#define IPF_NOWARNINGS             0x200 //L // 
#define IPF_ALLOWLZW               0x400 //L // 
...
#define IPDXF_BLACKONLY            0x00000001 //L // Import all DXF-Elements as black
#define IPDXF_IGNOREEXTMINMAX      0x00000002 //L // 
#define IPDXF_EXTENDED             0x00000004 //L // 

//------------------- Flags for Import DIB-Type selection --------
#define IPDIBF_IMPORT_32BIT       0x00020000 //L // 
#define IPDIBF_ALLOW_IMPORT_CMYK  0x00080000 //L //
#define IPDIBF_ALLOW_IMPORT_48BIT 0x00100000 //L // 
#define IPDIBF_ALLOW_IMPORT_RGBA  0x00400000 //L // 
#define IPDIBF_NORMALIZE            0x00800000 //L // 
